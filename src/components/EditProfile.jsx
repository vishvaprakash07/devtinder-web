...
const EditProfile = () => {
    ...
    return (
        <>
            ...
            <div className="flex justify-between items-start my-5 mx-50">
                    ...
                    <div className="card-body">
                        ...
                        <div>
                            ...
                            <fieldset className="fieldset">
                                ...
                                <input type="text" value={photoUrl} className="input" placeholder="Photo URL"
                            ...
                            <fieldset className="fieldset">
                                ...
                                <textarea value={about} className="input" placeholder="About"
                                    onChange={(e) => setAbout(e.target.value)} />
                            </fieldset>
                            <fieldset className="fieldset">
                                <legend className="fieldset-legend">Skills:</legend>
                                <input type="text" value={skills} className="input" placeholder="Skills"
                ...
                <UserCard user={{
                    firstName, lastName, photoUrl, gender, age, about, skills: skills
